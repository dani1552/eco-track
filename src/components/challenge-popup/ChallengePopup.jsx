...
const challengeData = {
  challenge1: {
    ...
    icon: "/src/assets/icons/challenge-1.svg",
    ...
    methods:
      "• 본인의 일정에 맞춰 매주 하루를 채식하는 날로 지정하세요. <br /> • 영양이 균형 잡힌 채식 식단을 미리 계획하세요. 다양한 채소, 과일, 곡물, 콩류 등으로 맛있고 건강한 식단을 구성할 수 있습니다. <br />• 콩고기, 두부, 버섯 등 육류를 대체할 수 있는 다양한 식재료를 활용해보세요. <br />• 가족이나 친구들과 함께 채식 도전에 동참하면 더 즐겁고 의미있는 경험이 될 수 있습니다.",
    precautions:
  ...
  challenge2: {
    ...
    icon: "/src/assets/icons/challenge-2.svg",
    date: "24.11.01 - 24.11.30",
    participants: 1030,
    description:
  ...
  challenge3: {
    ...
    icon: "/src/assets/icons/challenge-3.svg",
    date: "24.11.01 - 24.11.30",
    participants: 730,
    description:
  ...
  challenge4: {
    ...
    icon: "/src/assets/icons/challenge-4.svg",
    date: "24.11.01 - 24.11.30",
    participants: 407,
    description:
  ...
  challenge5: {
    ...
    icon: "/src/assets/icons/challenge-5.svg",
    date: "24.11.01 - 24.11.30",
    participants: 1217,
    description:
      "매주 하루 동안 육류를 소비하지 않고 채식 위주의 식사를 실천하는 도전입니다. 채식은 육류 생산 과정에서 발생하는 탄소 배출과 자원 낭비를 줄이고, 지구에 긍정적인 변화를 일으키기 위한 작은 실천입니다. 건강한 채식 메뉴를 계획하고 즐겁게 채식의 이점을 경험해보세요!",
